...
node {
    ...
    withCredentials([file(credentialsId: JWT_KEY_CRED_ID, variable: 'jwt_key_file')]) {
        stage('Authorize'){
        	...
        	//'C:/Users/p.rameshwar.wayal/SFDXKeys/server.key'
			rc = sh returnStatus: true, script: "\'${toolbelt}\'/sfdx force:auth:jwt:grant --clientid ${CONNECTED_APP_CONSUMER_KEY} --username ${HUB_ORG} --jwtkeyfile 'C:/Users/PrashT/SFDX_Keys/server.key' --setdefaultdevhubusername --instanceurl ${SFDC_HOST}"
